...
description: "AlphaFold helped predict protein structure; the next wave tackles something harder: how proteins move, switch states, and perform functions over time."
