---
title: "Why Real Breakthroughs Are Not One Person’s Victory"
date: 2026-04-02
draft: false
...
### Closing Punchline**Real breakthroughs are often not one person’s victory.**
...
### DisclaimerThis essay is a reflective commentary on scientific innovation, bibliometrics, and the interpretation of research. It is written for analytical and educational purposes only and does not constitute investment, legal, or policy advice.

### Further ReadingRecent essays from the same author have examined AI infrastructure from a different angle: the concentration of leverage across CoWoS, HBM, ABF substrates, and the broader semiconductor supply chain. This essay sits adjacent to that line of work, but turns to a more upstream question: how breakthroughs are formed, recognised, and remembered.

### Hashtags#Science #Innovation #Research #ScientificDiscovery#KnowledgeNetworks #Bibliometrics